...
class H1ExpSphereSnake(object):
    ...
    def _getScale(self, i):
        ...
        if i >= 0 and i < self.MR_1:
            ...
            scale = Snake3DScale(points=points, closed=self.lon_closed, color=Color(220, 20, 60))
    ...
    def estimateTwist(self, method='Selesnick'):
        if method=='Selesnick':
